...
var ASM_CONSTS = {
  2293552: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2293613: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2293677: function() {return Module.webglContextAttributes.powerPreference;},  
 2293735: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2293790: function($0) {performance.now = function() { return $0; };},  
 2293838: function($0) {performance.now = function() { return $0; };},  
 2293886: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _emscripten_resize_heap(requestedSize) {
      ...
      for (var cutDown = 1; cutDown <= 4; cutDown *= 2) {
        ...
        overGrownHeapSize = Math.min(overGrownHeapSize, requestedSize + 67108864 );
