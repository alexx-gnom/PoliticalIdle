...
var INITIAL_MEMORY = Module['INITIAL_MEMORY'] || 404750336;legacyModuleProp('INITIAL_MEMORY', 'INITIAL_MEMORY');
...
assert(INITIAL_MEMORY == 404750336, 'Detected runtime INITIAL_MEMORY setting.  Use -s IMPORTED_MEMORY to define wasmMemory dynamically');
...
function createWasm() {
  ...
  function receiveInstance(instance, module) {
    ...
    //assert(wasmMemory.buffer.byteLength === 404750336);
...
var ASM_CONSTS = {
  2292928: function() {return Module.webglContextAttributes.premultipliedAlpha;},  
 2292989: function() {return Module.webglContextAttributes.preserveDrawingBuffer;},  
 2293053: function() {return Module.webglContextAttributes.powerPreference;},  
 2293111: function() {Module['emscripten_get_now_backup'] = performance.now;},  
 2293166: function($0) {performance.now = function() { return $0; };},  
 2293214: function($0) {performance.now = function() { return $0; };},  
 2293262: function() {performance.now = Module['emscripten_get_now_backup'];}
};
  ...
  function _BuyStarsTgRequest(strs, label) 
  	{
  		try 
  		{
  			window.buyStarsTgRequest(strs, UTF8ToString(label));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _ConnectTonWallet() 
  	{
  		try 
  		{
  			window.triggerConnectTonWallet();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _DisconnectTonWallet() 
  	{
  		try 
  		{
  			window.triggerDisconnectTonWallet();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  async function _GenerateHmac(json, key, callback) 
  	{
  		try 
  		{
  			const encoder = new TextEncoder();
  
  			const encodedSecretKey = encoder.encode(UTF8ToString(key));
  			const encodedJsonData = encoder.encode(UTF8ToString(json));
  			...
  			var result = base64Hash.slice(0, 17);
  
  			var buffer = stringToNewUTF8(result);
  ...
  function _GetCrossPromoData() 
  	{
  		try 
  		{
  			window.triggerGetCrossPromoData();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _GetCrossPromoRewards() 
  	{
  		try 
  		{
  			//window.triggerGetCrossPromoRewards();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _GetFriends(locNum) 
  	{
  		try 
  		{
  			window.triggerGetFriendsData(locNum);
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _GetInviteLink() 
  	{
  		try 
  		{
  			window.triggerGetInviteLink();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _GetPartnerTaskRequest(key) 
  	{
  		try 
  		{
  			window.triggerGetPartnerTaskData(UTF8ToString(key));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _GetTasksRequest() 
  	{
  		try 
  		{
  			window.triggerGetTaskData();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _GetTonCopyAddress() 
  	{
  		try 
  		{
  			window.triggerGetTonCopyAddress();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _JoinToChannelRequest() 
  	{
  		try 
  		{
  			window.triggerJoinToChannelRequest();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _MoveToChannel() 
  	{
  		try 
  		{
  			window.triggerMoveToChannel();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _OpenTgUrlLink(url) 
  	{
  		try 
  		{
  			window.openTgLink(UTF8ToString(url));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _OpenUrlLink(url) 
  	{
  		try 
  		{
  			window.App.openNotTelegramLink(UTF8ToString(url));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _SaveCommonJson(str) 
  	{
  		try 
  		{
  			window.sendCommonSaveData(UTF8ToString(str));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _SaveLocJson(str) 
  	{
  		try 
  		{
  			window.sendSaveData(UTF8ToString(str));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _SendAdjEvent(eventName, parameters) 
  	{
  		try 
  		{
  			window.sendAdjustEvent(UTF8ToString(eventName), UTF8ToString(parameters));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _SendFirstBuyCompany(json) 
  	{
  		try 
  		{
  			window.SendFirstBuyCompany(UTF8ToString(json));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _SendFriendsRewarded(json) 
  	{
  		try 
  		{
  			window.sendRewardedFriends(UTF8ToString(json));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _SendHideLoadingScr() 
  	{
  		try 
  		{
  			window.triggerHideLoading();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _SendStarsOneRewardAccrued(json) 
  	{
  		try 
  		{
  			window.sendStarsOneRwAccrued(UTF8ToString(json));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _SendStarsTgAccrued(json) 
  	{
  		try 
  		{
  			window.sendStarsTgAccrued(UTF8ToString(json));
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _SetLocationInitialized(locNum) 
  	{
  		try 
  		{
  			window.setLocationInitialized(locNum);
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _UpdateTonData() 
  	{
  		try 
  		{
  			window.triggerUpdateTonData();
  		} 
  		catch (err) 
  		{
  			console.log(err);
  ...
  function _emscripten_resize_heap(requestedSize) {
      ...
      for (var cutDown = 1; cutDown <= 4; cutDown *= 2) {
        var overGrownHeapSize = oldSize + 67108864 / cutDown; // ensure linear growth
...
var asmLibraryArg = {
  "BuyStarsTgRequest": _BuyStarsTgRequest,
  "ClearAllData": _ClearAllData,
  "CloseApp": _CloseApp,
  "ConnectTonWallet": _ConnectTonWallet,
  "DisconnectTonWallet": _DisconnectTonWallet,
  "GenerateHmac": _GenerateHmac,
  "GetCrossPromoData": _GetCrossPromoData,
  "GetCrossPromoRewards": _GetCrossPromoRewards,
  "GetFriends": _GetFriends,
  "GetInviteLink": _GetInviteLink,
  "GetJSMemoryInfo": _GetJSMemoryInfo,
  "GetPartnerTaskRequest": _GetPartnerTaskRequest,
  "GetSave": _GetSave,
  "GetTasksRequest": _GetTasksRequest,
  "GetTonCopyAddress": _GetTonCopyAddress,
  ...
  "JoinToChannelRequest": _JoinToChannelRequest,
  "MoveToChannel": _MoveToChannel,
  "OpenTgUrlLink": _OpenTgUrlLink,
  "OpenUrlLink": _OpenUrlLink,
  "SaveCommonJson": _SaveCommonJson,
  "SaveLocJson": _SaveLocJson,
  "SendAdjEvent": _SendAdjEvent,
  "SendFirstBuyCompany": _SendFirstBuyCompany,
  "SendFriendsRewarded": _SendFriendsRewarded,
  "SendHideLoadingScr": _SendHideLoadingScr,
  "SendStarsOneRewardAccrued": _SendStarsOneRewardAccrued,
  "SendStarsTgAccrued": _SendStarsTgAccrued,
  "SetLocationInitialized": _SetLocationInitialized,
  "UpdateTonData": _UpdateTonData,
...
/** @type {function(...*):?} */
var dynCall_dddiifi = Module["dynCall_dddiifi"] = createExportWrapper("dynCall_dddiifi");
